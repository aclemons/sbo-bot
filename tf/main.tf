...
resource "aws_lambda_function" "githubapp_lambda" {
  ...
  environment {
    variables = {
      ...
      GITHUB_CONTRIBUTORS = "bassmadrigal,Ythogtha,maramon,mac-a-r0ni,earies,isaackwy,pghvlaans,ArTourter,atelszewski,rizitis,antonioleal,fsLeg,cwilling,rizitis,linrs,r1w1s1,newHeiko,RezaT4795,mattegger,afhpayne,lecramyajiv,wkdjgf534,perrin4869,pyllyukko,andy5995"
      WEBHOOK_PATH  = "/"
      LOG_LEVEL      = "info"
    }
  }
